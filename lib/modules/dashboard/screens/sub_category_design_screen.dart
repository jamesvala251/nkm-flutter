...
import 'package:nkm_nose_pins_llp/modules/dashboard/widgets/sub_category_design_list_item.dart';
...
class _SubCategoryDesignScreenState extends State<SubCategoryDesignScreen> {
            ...
            child: Obx(
              () => _subCategoryController.isLoadingSubCateDesign.value
                  ...
                  : _subCategoryController
                      ...
                      ? _subCategoryController
                              .designSubCategoryModel.data.isNotEmpty
                          ? _getSubCategoryListWidget
                          : NoDataFoundWidget(
  ...
  Widget get _getSubCategoryListWidget => GridView.builder(
        padding: EdgeInsets.zero,
        itemCount: _subCategoryController.designSubCategoryModel.data.length,
        ...
        itemBuilder: (ctx, index) => SubCategoryDesignListItemWidget(
          subCategoryController: _subCategoryController,
          subCateItem:
              _subCategoryController.designSubCategoryModel.data[index],
          goldKarat: goldKarat,
        ),
      );
}
