...
class _VideoViewScreenState extends State<VideoViewScreen> {
  ...
  void initState() {
    ...
    cateDesignListItem =
        temp[RouteConstants.productListItemModel] ;
    goldKarat = temp[RouteConstants.goldKarat] as String;
    title = cateDesignListItem.name;
    videoUrl = cateDesignListItem.videos.isNotEmpty
        ? cateDesignListItem.videos.first
        : '';
    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
          ...
          child: Obx(
            () => cateDesignListItem.isLoadingVideo.value
          ...
          onPressed: () {
            if (cateDesignListItem.isLoadingVideo.value) return;
            cateDesignListItem.shareVideo(
              goldKarat: goldKarat,
            );
          },
        ),
